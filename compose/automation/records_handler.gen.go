...
func (h recordsHandler) LookupByID() *atypes.Function {
	return &atypes.Function{
		...
		Handler: func(ctx context.Context, in *expr.Vars) (out *expr.Vars, err error) {
			...
			out = &expr.Vars{}
			_ = expr.Set(out, "record", expr.Must(h.reg.Type("ComposeRecord").Cast(results.Record)))
...
func (h recordsHandler) Validate() *atypes.Function {
	return &atypes.Function{
		...
		Handler: func(ctx context.Context, in *expr.Vars) (out *expr.Vars, err error) {
			...
			out = &expr.Vars{}
			_ = expr.Set(out, "valid", expr.Must(h.reg.Type("Boolean").Cast(results.Valid)))
			_ = expr.Set(out, "errors", expr.Must(h.reg.Type("RecordValueErrorSet,").Cast(results.Errors)))
