...
//
//	case "createdAt":
//		return expr.SetDateTimeWithPath(&rec.CreatedAt, val, pp[1:]...)
//
//	case "createdBy":
//		return expr.SetIDWithPath(&rec.CreatedBy, val, pp[1:]...)
//
//	case "updatedAt":
//		return expr.SetDateTimeWithPath(rec.UpdatedAt, val, pp[1:]...)
//
//	case "updatedBy":
//		return expr.SetIDWithPath(&rec.UpdatedBy, val, pp[1:]...)
//
//	case "deletedAt":
//		return expr.SetDateTimeWithPath(rec.DeletedAt, val, pp[1:]...)
//
//	case "deletedBy":
